...
\section{Discussion}
% Prometheus: the problem was that it is not scaling to 4k
...
% - prometheus: although one can see that it scales bad, it is bad bc the prometheus server still has a shitload of load mock clients
% - jitter: the data were SO MUCH, count how many exactly...

\section{Conclusion}
% bla bla benchmark design
% bla bla nochmal methodology durchgehen generell was man gemacht hat
% results:
% - node exporter scaled selbst gut genug
% - jitter keine ahunng
% - prometheus: scaled nicht, der throughput ist ass bei 1500 und bei 2000 breaked es, selbst
