...
\subsection{Setup}
% - besides for the jitter benchmark, the following hardware was used
%   - A gcn2 type node from Emmy
%   - 2 x Xeon Platinum 9242 with 48 cores each
%   - 376GB ram
% - for the jitter benchmarks, I wanted to have a very minimal operating system
%   - Thus I installed X on a local (fast) USB stick
% - Using pre-installed version of node exporter
