...
\newcommand{\thesistitle}{Scalability Evaluation of Prometheus for HPC Monitoring}
\newcommand{\supervisor}{Marcus Merz, Prof. Dr. Julian Kunkel}
...
\begin{itemize}
	...
	\item[\ccheckmark] Other, namely: GitHub Copilot as a coding assistant
\end{itemize}
